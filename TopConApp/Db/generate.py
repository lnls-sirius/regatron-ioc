...
MAPPING = [
    ...
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADOvrRng1-Mon',  'proto':'getModStdErrGroup8', 'addr':0x0050A9, 'DESC':'Std err group 8',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADOvrRng2-Mon',  'proto':'getModStdErrGroup9', 'addr':0x0050AA, 'DESC':'Std err group 9',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADUndrRng1-Mon', 'proto':'getModStdErrGroupA', 'addr':0x0050AB, 'DESC':'Std err group A',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADUndrRng2-Mon', 'proto':'getModStdErrGroupB', 'addr':0x0050AC, 'DESC':'Std err group B',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADOvrRng1-Mon',  'proto':'getSysStdErrGroup8', 'addr':0x0050A9, 'DESC':'Std err group 8',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADOvrRng2-Mon',  'proto':'getSysStdErrGroup9', 'addr':0x0050AA, 'DESC':'Std err group 9',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADUndrRng1-Mon', 'proto':'getSysStdErrGroupA', 'addr':0x0050AB, 'DESC':'Std err group A',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADUndrRng2-Mon', 'proto':'getSysStdErrGroupB', 'addr':0x0050AC, 'DESC':'Std err group B',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
