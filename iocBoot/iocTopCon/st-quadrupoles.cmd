...
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-QFAP, PORT=P1")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-QFB, PORT=P2")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-QDAP12, PORT=P3")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-QDB12, PORT=P4")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-Q12_A, PORT=P5")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-Q12_B, PORT=P6")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-Q12_C, PORT=P7")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-Q33_A, PORT=P8")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-Q33_B, PORT=P9")
dbLoadRecords("db/TopCon.db",       "DEVICE=PA-RaPS?:SI-Reg:PS-Q33_C, PORT=P10")
dbLoadRecords("db/TopConMaster.db", "DEVICE=PA-RaPS?:SI-Reg:PS-QFAP, PORT=P1")
dbLoadRecords("db/TopConMaster.db", "DEVICE=PA-RaPS?:SI-Reg:PS-QFB, PORT=P2")
dbLoadRecords("db/TopConMaster.db", "DEVICE=PA-RaPS?:SI-Reg:PS-QDAP12, PORT=P3")
dbLoadRecords("db/TopConMaster.db", "DEVICE=PA-RaPS?:SI-Reg:PS-QDB12, PORT=P4")
dbLoadRecords("db/TopConMaster.db", "DEVICE=PA-RaPS?:SI-Reg:PS-Q12_A, PORT=P5")
dbLoadRecords("db/TopConMaster.db", "DEVICE=PA-RaPS?:SI-Reg:PS-Q33_A, PORT=P8")
