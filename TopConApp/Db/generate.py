...
MAPPING = [
    ...
    {'r':'uint16_r', 'pv':'Mod-ExtWarnIBCInv-Mon',         'proto':'getModExtWarnGroupL', 'addr':0x302A16, 'DESC':'Ext warning group L',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Mod-ExtWarnIBCInv2-Mon',        'proto':'getModExtWarnGroupN', 'addr':0x302A18, 'DESC':'Ext warning group N',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Sys-ExtWarnIBCInv-Mon',         'proto':'getSysExtWarnGroupL', 'addr':0x302A16, 'DESC':'Ext warning group L',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Sys-ExtWarnIBCInv2-Mon',        'proto':'getSysExtWarnGroupN', 'addr':0x302A18, 'DESC':'Ext warning group N',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Mod-ExtErrIBCInv-Mon',          'proto':'getModExtErrGroupL', 'addr':0x302A05, 'DESC':'Ext err group L',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Mod-ExtErrIBCInv2-Mon',         'proto':'getModExtErrGroupN', 'addr':0x302A07, 'DESC':'Ext err group N',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Sys-ExtErrIBCInv-Mon',          'proto':'getSysExtErrGroupL', 'addr':0x302A05, 'DESC':'Ext err group L',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Sys-ExtErrIBCInv2-Mon',         'proto':'getSysExtErrGroupN', 'addr':0x302A07, 'DESC':'Ext err group N',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    ...
    {'r':'sint16_r', 'pv':'ActiveInterface-Mon',        'proto':'getActiveInterface', 'addr':0x005087, 'DESC':'Active interface', 'type':'mbbi', 'PINI':'YES', 'ZRST': 'Analog/Digital Inputs', 'ONST':'HMI', 'TWST':'RS232', 'THST':'Intrn', 'FRST':'passiv', 'FRVL': '32767'},
