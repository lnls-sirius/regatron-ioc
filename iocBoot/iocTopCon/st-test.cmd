...
dbLoadRecords("db/GenericCmd.db",    "D=RegTest,P=P0") # OK
#dbLoadRecords("db/GenericGetSet.db", "D=RegTest,P=P0") # OK
dbLoadRecords("db/GenericMon.db",    "D=RegTest,P=P0")
#dbLoadRecords("db/TempMon.db",       "D=RegTest,P=P0") # OK

#dbLoadRecords("db/ModMon.db",        "D=RegTest,P=P0")
#dbLoadRecords("db/ModTree.db",       "D=RegTest,P=P0") # OK
