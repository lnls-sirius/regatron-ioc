...
MAPPING = [
    ...
    {'r':'uint16_r', 'pv':'Mod:StdWarnTemperature-Mon',    'proto':'getModStdWarnGroup5', 'addr':0x0050A0, 'DESC':'Std warning group 5',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Mod:StdWarnIntrnModulator-Mon', 'proto':'getModStdWarnGroup7', 'addr':0x0050B0, 'DESC':'Std warning group 7',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdWarnIntrnADOvrRng1-Mon', 'proto':'getModStdWarnGroup8', 'addr':0x0050B1, 'DESC':'Std warning group 8',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdWarnIntrnADOvrRng2-Mon', 'proto':'getModStdWarnGroup9', 'addr':0x0050B2, 'DESC':'Std warning group 9',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdWarnIntrnADUndrRng1-Mon','proto':'getModStdWarnGroupA', 'addr':0x0050B3, 'DESC':'Std warning group A',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdWarnIntrnADUndrRng2-Mon','proto':'getModStdWarnGroupB', 'addr':0x0050B4, 'DESC':'Std warning group B',    'PINI':'NO', 'type':'longin', 'SELECT':Select.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Sys:StdWarnTemperature-Mon',    'proto':'getSysStdWarnGroup5', 'addr':0x0050A0, 'DESC':'Std warning group 5',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    ...
    {'r':'uint16_r', 'pv':'Sys:StdWarnIntrnModulator-Mon', 'proto':'getSysStdWarnGroup7', 'addr':0x0050B0, 'DESC':'Std warning group 7',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdWarnIntrnADOvrRng1-Mon', 'proto':'getSysStdWarnGroup8', 'addr':0x0050B1, 'DESC':'Std warning group 8',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdWarnIntrnADOvrRng2-Mon', 'proto':'getSysStdWarnGroup9', 'addr':0x0050B2, 'DESC':'Std warning group 9',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdWarnIntrnADUndrRng1-Mon','proto':'getSysStdWarnGroupA', 'addr':0x0050B3, 'DESC':'Std warning group A',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdWarnIntrnADUndrRng2-Mon','proto':'getSysStdWarnGroupB', 'addr':0x0050B4, 'DESC':'Std warning group B',    'PINI':'NO','type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    ...
    # Err Monitoring
    {'r':'uint16_r', 'pv':'Mod:StdErrGroup-Mon',           'proto':'getModStdErrGroup',  'addr':0x00508D, 'DESC':'Standard error group',    'PINI':'NO','type':'longin', 'SELECT':Select.MASTER, 'SCAN':'10 second'},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrn-Mon',           'proto':'getModStdErrGroup0', 'addr':0x005093, 'DESC':'Std error group 0',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnPDSP-Mon',       'proto':'getModStdErrGroup1', 'addr':0x005094, 'DESC':'Std error group 1',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrOutCurrent-Mon',      'proto':'getModStdErrGroup2', 'addr':0x005095, 'DESC':'Std error group 2',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrOutVolt-Mon',         'proto':'getModStdErrGroup3', 'addr':0x005096, 'DESC':'Std error group 3',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrSupply-Mon',          'proto':'getModStdErrGroup4', 'addr':0x005097, 'DESC':'Std error group 4',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrTemperature-Mon',     'proto':'getModStdErrGroup5', 'addr':0x005098, 'DESC':'Std error group 5',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrComm-Mon',            'proto':'getModStdErrGroup6', 'addr':0x005099, 'DESC':'Std error group 6',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnModulator-Mon',  'proto':'getModStdErrGroup7', 'addr':0x0050A8, 'DESC':'Std error group 7',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADOvrRng1-Mon',  'proto':'getModStdErrGroup8', 'addr':0x0050A9, 'DESC':'Std error group 8',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADOvrRng2-Mon',  'proto':'getModStdErrGroup9', 'addr':0x0050AA, 'DESC':'Std error group 9',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADUndrRng1-Mon', 'proto':'getModStdErrGroupA', 'addr':0x0050AB, 'DESC':'Std error group A',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrIntrnADUndrRng2-Mon', 'proto':'getModStdErrGroupB', 'addr':0x0050AC, 'DESC':'Std error group B',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrLogin-Mon',           'proto':'getModStdErrGroupC', 'addr':0x0050AD, 'DESC':'Std error group C',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrConf-Mon',            'proto':'getModStdErrGroupD', 'addr':0x0050AE, 'DESC':'Std error group D',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrConf2-Mon',           'proto':'getModStdErrGroupE', 'addr':0x0050AF, 'DESC':'Std error group E',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:StdErrMisc-Mon',            'proto':'getModStdErrGroupF', 'addr':0x00509A, 'DESC':'Std error group F',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrGroup-Mon',           'proto':'getModExtErrGroup',  'addr':0x302A00, 'DESC':'Extended error group',    'PINI':'NO','type':'longin', 'SELECT':Select.MASTER, 'SCAN':'10 second'},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIBCSystem-Mon',       'proto':'getModExtErrGroupG', 'addr':0x302A01, 'DESC':'Ext error group G',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIBCSuppply-Mon',      'proto':'getModExtErrGroupH', 'addr':0x302A02, 'DESC':'Ext error group H',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIBCComm-Mon',         'proto':'getModExtErrGroupJ', 'addr':0x302A03, 'DESC':'Ext error group J',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIBCPwr-Mon',          'proto':'getModExtErrGroupK', 'addr':0x302A04, 'DESC':'Ext error group K',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIBCInverter-Mon',     'proto':'getModExtErrGroupL', 'addr':0x302A05, 'DESC':'Ext error group L',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIBCMisc-Mon',         'proto':'getModExtErrGroupM', 'addr':0x302A06, 'DESC':'Ext error group M',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIBCInverter2-Mon',    'proto':'getModExtErrGroupN', 'addr':0x302A07, 'DESC':'Ext error group N',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrSupply2-Mon',         'proto':'getModExtErrGroupS', 'addr':0x302A0B, 'DESC':'Ext error group S',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrLogin2-Mon',          'proto':'getModExtErrGroupT', 'addr':0x302A0C, 'DESC':'Ext error group T',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrConf3-Mon',           'proto':'getModExtErrGroupU', 'addr':0x302A0D, 'DESC':'Ext error group U',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrComm3-Mon',           'proto':'getModExtErrGroupV', 'addr':0x302A0E, 'DESC':'Ext error group V',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrIntrn2-Mon',          'proto':'getModExtErrGroupW', 'addr':0x302A0F, 'DESC':'Ext error group W',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},
    {'r':'uint16_r', 'pv':'Mod:ExtErrComm2-Mon',           'proto':'getModExtErrGroupX', 'addr':0x302A10, 'DESC':'Ext error group X',       'PINI':'NO','type':'longin', 'SELECT':Select.MASTER},

    {'r':'uint16_r', 'pv':'Sys:StdErrGroup-Mon',           'proto':'getSysStdErrGroup',  'addr':0x00508D, 'DESC':'Standard error group',    'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER, 'SCAN':'10 second'},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrn-Mon',           'proto':'getSysStdErrGroup0', 'addr':0x005093, 'DESC':'Std error group 0',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnPDSP-Mon',       'proto':'getSysStdErrGroup1', 'addr':0x005094, 'DESC':'Std error group 1',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrOutCurrent-Mon',      'proto':'getSysStdErrGroup2', 'addr':0x005095, 'DESC':'Std error group 2',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrOutVolt-Mon',         'proto':'getSysStdErrGroup3', 'addr':0x005096, 'DESC':'Std error group 3',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrSupply-Mon',          'proto':'getSysStdErrGroup4', 'addr':0x005097, 'DESC':'Std error group 4',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrTemperature-Mon',     'proto':'getSysStdErrGroup5', 'addr':0x005098, 'DESC':'Std error group 5',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrComm-Mon',            'proto':'getSysStdErrGroup6', 'addr':0x005099, 'DESC':'Std error group 6',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnModulator-Mon',  'proto':'getSysStdErrGroup7', 'addr':0x0050A8, 'DESC':'Std error group 7',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADOvrRng1-Mon',  'proto':'getSysStdErrGroup8', 'addr':0x0050A9, 'DESC':'Std error group 8',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADOvrRng2-Mon',  'proto':'getSysStdErrGroup9', 'addr':0x0050AA, 'DESC':'Std error group 9',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADUndrRng1-Mon', 'proto':'getSysStdErrGroupA', 'addr':0x0050AB, 'DESC':'Std error group A',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrIntrnADUndrRng2-Mon', 'proto':'getSysStdErrGroupB', 'addr':0x0050AC, 'DESC':'Std error group B',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrLogin-Mon',           'proto':'getSysStdErrGroupC', 'addr':0x0050AD, 'DESC':'Std error group C',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrConf-Mon',            'proto':'getSysStdErrGroupD', 'addr':0x0050AE, 'DESC':'Std error group D',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrConf2-Mon',           'proto':'getSysStdErrGroupE', 'addr':0x0050AF, 'DESC':'Std error group E',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:StdErrMisc-Mon',            'proto':'getSysStdErrGroupF', 'addr':0x00509A, 'DESC':'Std error group F',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrGroup-Mon',           'proto':'getSysExtErrGroup',  'addr':0x302A00, 'DESC':'Extended error group',    'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER, 'SCAN':'10 second'},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIBCSystem-Mon',       'proto':'getSysExtErrGroupG', 'addr':0x302A01, 'DESC':'Ext error group G',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIBCSuppply-Mon',      'proto':'getSysExtErrGroupH', 'addr':0x302A02, 'DESC':'Ext error group H',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIBCComm-Mon',         'proto':'getSysExtErrGroupJ', 'addr':0x302A03, 'DESC':'Ext error group J',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIBCPwr-Mon',          'proto':'getSysExtErrGroupK', 'addr':0x302A04, 'DESC':'Ext error group K',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIBCInverter-Mon',     'proto':'getSysExtErrGroupL', 'addr':0x302A05, 'DESC':'Ext error group L',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIBCMisc-Mon',         'proto':'getSysExtErrGroupM', 'addr':0x302A06, 'DESC':'Ext error group M',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIBCInverter2-Mon',    'proto':'getSysExtErrGroupN', 'addr':0x302A07, 'DESC':'Ext error group N',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrSupply2-Mon',         'proto':'getSysExtErrGroupS', 'addr':0x302A0B, 'DESC':'Ext error group S',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrLogin2-Mon',          'proto':'getSysExtErrGroupT', 'addr':0x302A0C, 'DESC':'Ext error group T',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrConf3-Mon',           'proto':'getSysExtErrGroupU', 'addr':0x302A0D, 'DESC':'Ext error group U',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrComm3-Mon',           'proto':'getSysExtErrGroupV', 'addr':0x302A0E, 'DESC':'Ext error group V',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrIntrn2-Mon',          'proto':'getSysExtErrGroupW', 'addr':0x302A0F, 'DESC':'Ext error group W',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
    {'r':'uint16_r', 'pv':'Sys:ExtErrComm2-Mon',           'proto':'getSysExtErrGroupX', 'addr':0x302A10, 'DESC':'Ext error group X',       'PINI':'NO', 'type':'longin', 'SELECT':Select.SYSTEM, 'RESTRICT':Restrict.MASTER},
