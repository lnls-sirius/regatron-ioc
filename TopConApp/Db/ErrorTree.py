...
# Warning Monitoring
mod_std_warn = {
    "params": {"pv": "$(D):Mod-StdWarn", "func": "getModStdWarnTree", "scan": ""},
    "items": [
...
mod_ext_warn = {
    "params": {"pv": "$(D):Mod-ExtWarn", "func": "getModExtWarnTree", "scan": ""},
    "items": [
        {"pv": "$(D):Mod-ExtWarnGroup-Mon", "desc": "Ext warn group",},
...
# Warning Monitoring
sys_std_warn = {
    "params": {"pv": "$(D):Sys-StdWarn", "func": "getSysStdWarnTree", "scan": ""},
    "items": [
...
sys_ext_warn = {
    "params": {"pv": "$(D):Sys-ExtWarn", "func": "getSysExtWarnTree", "scan": ""},
    "items": [
        {"pv": "$(D):Sys-ExtWarnGroup-Mon", "desc": "Ext warn group",},
...
# Erring Monitoring
mod_std_err = {
    "params": {"pv": "$(D):Mod-StdErr", "func": "getModStdErrTree", "scan": ""},
    "items": [
...
mod_ext_err = {
    "params": {"pv": "$(D):Mod-ExtErr", "func": "getModExtErrTree", "scan": ""},
    "items": [
        {"pv": "$(D):Mod-ExtErrGroup-Mon", "desc": "Ext warn group",},
...
# Error Monitoring
sys_std_err = {
    "params": {"pv": "$(D):Sys-StdErr", "func": "getSysStdErrTree", "scan": ""},
    "items": [
...
sys_ext_err = {
    "params": {"pv": "$(D):Sys-StdErr", "func": "getSysExtErrTree", "scan": ""},
    "items": [
        {"pv": "$(D):Sys-ExtErrGroup-Mon", "desc": "Ext warn group",},
...
if __name__ == "__main__":
    proto = "@reg.proto"
    regs = [
        {"file": "SysStdWarn.db", "entries": sys_std_warn},
        {"file": "SysExtWarn.db", "entries": sys_ext_warn},
        {"file": "ModStdWarn.db", "entries": mod_std_warn},
        {"file": "ModExtWarn.db", "entries": mod_ext_warn},
        {"file": "SysStdErr.db", "entries": sys_std_err},
        {"file": "SysExtErr.db", "entries": sys_ext_err},
        {"file": "ModStdErr.db", "entries": mod_std_err},
        {"file": "ModExtErr.db", "entries": mod_ext_err},
    ]
    for reg in regs:
